...
var playlistDiv = document.getElementById("playlist-wrapper");
for (let i = 0; i < 10; i++) {
    playlistDiv.appendChild(createPlaylistCard(playlistData[i]), i);
}
...
function removeClass() {
    for (i = 0; i < 10; i++) {
        document
            .getElementById("card" + playlistData[i].id)
